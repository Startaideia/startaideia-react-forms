  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: "https://github.com/Startaideia/startaideia-react-forms",
          label: "GitHub",
          position: "right",
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} React Forms. Built with love by Startaideia.`,
    },
  },
  presets: [
    [
